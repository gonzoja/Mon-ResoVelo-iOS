...
@implementation MonResoVeloAppDelegate
...
{
    MonResoVeloAppDelegate *appDelegate = [[UIApplication sharedApplication] delegate];
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"MonResoVelo" ofType:@"momd"];
